<%@ Page AutoEventWireup="true" CodeFile="Linens.aspx.cs" Inherits="Linens" Language="C#" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title><%= Globals.g.Company.Name %> - Linens</title>
	<!-- Linens.aspx -->
		...
		<table cellspacing="0" cellpadding="0" align="center" border="0" width="100%">
			<tr>
				<td>
					...
					<% Pg.JobSubPage("Linens"); %>
				</td>
			</tr>
			<tr>
				<td>
                    <asp:Table ID="tblLinens" BorderWidth="0" CellPadding="0" CellSpacing="0" HorizontalAlign="Center" CssClass="EditData" runat="server">
                        <asp:TableRow>
                            <asp:TableHeaderCell />
                            ...
                            <asp:TableHeaderCell>Ordered</asp:TableHeaderCell>
