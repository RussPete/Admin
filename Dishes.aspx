<%@ Page AutoEventWireup="true" CodeFile="Dishes.aspx.cs" Inherits="Dishes" Language="C#" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
	<head>
		<title><%= Globals.g.Company.Name %> - Dishes</title> 
		<!-- Dishes.aspx -->
	...
	<body onbeforeunload="CheckDirty();" onload="Init();">
		<form id="form" method="post" runat="server" autocomplete="off">
			...
			<asp:panel id="pnlEdit" runat="server">
				<table cellspacing="0" cellpadding="0" align="center" border="0">
					<tr>
						...
						<td valign="top" align="center">
								...
								<tr>
									<td align="center">
										<table cellspacing="0" cellpadding="0" border="0">
											<tr>
												<td><img onmouseover="SetImg(this, 'Images/ShowAllLgt.gif');" onclick="OpenPage('Dishes.aspx?View=Show');"
							...
							<% Pg.JobSubPage("Dishes"); %>
							<asp:table id="tblDishes" runat="server" cellspacing="0" cellpadding="0">
								<asp:tablerow>
									...
									<asp:tablecell width="10px" Visible="false"></asp:tablecell>
									<asp:tablecell text="Note" font-bold="true" Visible="false"></asp:tablecell>
								</asp:tablerow>
							</asp:table>
							<table cellspacing="0" cellpadding="0" align="center" border="0">
								<tr>
				...
				<asp:textbox id="txtcDishes" runat="server" visible="False"></asp:textbox>
			</asp:panel>
			<asp:panel id="pnlShow" runat="server">
						...
						<td align="center">
							<table cellspacing="0" cellpadding="0" border="0">
								<tr>
									...
									<td><img height="1" src="Images/Space.gif" alt="" width="1"></td>
									<td><img onmouseover="SetImg(this, 'Images/EditLgt.gif');" onclick="OpenPage('Dishes.aspx?View=Edit');"
				...
				<% Pg.JobSubPage("Dishes"); %>
				<asp:table id="tblShowDishes" runat="server" cellspacing="0" cellpadding="0" horizontalalign="Center" CssClass="EditData">
					<asp:tablerow>
						<asp:tablecell verticalalign="Top" runat="server" id="tdShowDishes1" cssclass="ColTable" visible="False">
							<asp:table id="tblShowDishes1" runat="server" cellpadding="0" cellspacing="0" horizontalalign="Center"></asp:table>
						</asp:tablecell>
						<asp:tablecell>
							<asp:image id="imgShowDishes" runat="server" width="0" height="0" imageurl="Images/Space.gif"></asp:image>
						</asp:tablecell>
						<asp:tablecell verticalalign="Top" runat="server" id="tdShowDishes2" cssclass="ColTable" visible="False">
							<asp:table id="tblShowDishes2" runat="server" cellpadding="0" cellspacing="0" horizontalalign="Center"></asp:table>
						</asp:tablecell>
					</asp:tablerow>
				</asp:table>
				<table cellspacing="0" cellpadding="0" align="center" border="0">
				...
				<asp:textbox id="txtcShowDishes" runat="server" visible="False"></asp:textbox>
			</asp:panel>
