...
<html xmlns="http://www.w3.org/1999/xhtml" >
	<head>
		<title><%= Globals.g.Company.Name %> - Invoice</title> 
		<!-- Invoice.aspx -->
		    ...
		    ({
		        ...
		        buttons:
			    {
			        ...
			        Email: function ()
			        {
			            ...
			            ClearDirty();
			            $("#txtSubject").val("Deposit Invoice from <%= Globals.g.Company.Name %>");
			            $("#txtMessage").val("Please see the attached deposit invoice from <%= Globals.g.Company.Name %>.\n\nWe appreciate your business.");
			            Email();
			            fDirty = fPrevDirty;
			        },
