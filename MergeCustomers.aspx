<%@ Page AutoEventWireup="true" CodeFile="MergeCustomers.aspx.cs" Inherits="MergeCustomers" Language="C#" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title><%= Globals.g.Company.Name %> - Merge Customers</title>
	<!-- MergeContacts.aspx -->
	...
	<table cellspacing="0" cellpadding="0" align="center" border="0">
		<tr>
            ...
            <td style="vertical-align: top;">
                <div id="content">
                    <div class="FeatureMain">Merge Customers</div>
                    <ul class="Fields">
                        <li>
                        ...
                        <li>
                            <label class="Prompt">Tax Exempt</label>
                            <asp:RadioButton ID="rdoTaxExempt1" GroupName="TaxExempt" CssClass="Name" runat="server" />
                            <asp:RadioButton ID="rdoTaxExempt2" GroupName="TaxExempt" CssClass="Name" runat="server" />
                        </li>
                        <li>
                            <label class="Prompt">Company</label>
                            <asp:RadioButton ID="rdoCompany1" GroupName="Company" CssClass="Name" runat="server" />
                            <asp:RadioButton ID="rdoCompany2" GroupName="Company" CssClass="Name" runat="server" />
                        </li>
                        <li>
                            <label class="Prompt">Online Order</label>
                            <asp:RadioButton ID="rdoOnlineOrder1" GroupName="OnlineOrder" CssClass="Name" runat="server" />
                            <asp:RadioButton ID="rdoOnlineOrder2" GroupName="OnlineOrder" CssClass="Name" runat="server" />
                        </li>
                        <li>
                            <label class="Prompt">Email Confirmations</label>
                            <asp:RadioButton ID="rdoEmailConf1" GroupName="EmailConf" CssClass="Name" runat="server" />
                            <asp:RadioButton ID="rdoEmailConf2" GroupName="EmailConf" CssClass="Name" runat="server" />
                        </li>
                        <li>
                            <label class="Prompt">Annual Contract Signed By</label>
                            <asp:RadioButton ID="rdoSignedBy1" GroupName="SignedBy" CssClass="Name" runat="server" />
                            <asp:RadioButton ID="rdoSignedBy2" GroupName="SignedBy" CssClass="Name" runat="server" />
                        </li>
                        <li>
                            <label class="Prompt">Annual Contract Signed</label>
                            <asp:RadioButton ID="rdoSigned1" GroupName="Signed" CssClass="Name" runat="server" />
                            <asp:RadioButton ID="rdoSigned2" GroupName="Signed" CssClass="Name" runat="server" />
                        </li> 
                    </ul>
