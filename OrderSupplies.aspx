<%@ page autoeventwireup="true" codefile="OrderSupplies.aspx.cs" inherits="OrderSupplies"
	language="C#" %>
...
<body onload="Init();">
	<form id="form" method="post" runat="server" autocomplete="off">
		...
		<% Pg.Top(); %>
			<div class="FeatureMain">Supplies</div>
            <div>
                <div style="text-align: center;">
        			<ul class="Items" id="ulItems1" runat="server" />
        			<ul class="Items" id="ulItems2" runat="server" />
			    </div>
