/* increase mcJobFood.ProposalMenuItem to 1000 from 100 */
...
BEGIN TRANSACTION
GO
ALTER TABLE dbo.mcJobFood
	DROP CONSTRAINT DF_mcJobFood_ProposalHideFlg
GO
...
IF EXISTS(SELECT * FROM dbo.mcJobFood)
	 EXEC('INSERT INTO dbo.Tmp_mcJobFood (JobFoodRno, JobRno, FoodSeq, Category, MenuItem, MenuItemRno, Qty, QtyNote, ServiceNote, ProposalSeq, ProposalMenuItem, ProposalHideFlg, CreatedDtTm, CreatedUser, UpdatedDtTm, UpdatedUser)
		SELECT JobFoodRno, JobRno, FoodSeq, Category, MenuItem, MenuItemRno, Qty, QtyNote, ServiceNote, ProposalSeq, ProposalMenuItem, ProposalHideFlg, CreatedDtTm, CreatedUser, UpdatedDtTm, UpdatedUser FROM dbo.mcJobFood WITH (HOLDLOCK TABLOCKX)')
GO
