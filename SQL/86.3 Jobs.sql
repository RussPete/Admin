-- add 	VoluntaryGratuitySubTotPctFlg and VoluntaryGratuitySubTotPct
...
IF EXISTS(SELECT * FROM dbo.mcJobs)
    ...
    SELECT JobRno, 
        ...
        --JobDesc, ContactRno, ContractSendDtTm, ContractSignedFileName, 
        --JobDesc, ContactRno, ContractSendDtTm, ContractSignedFileName, 
GO
