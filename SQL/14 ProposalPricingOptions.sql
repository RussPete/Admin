/* add OptionType to ProposalPricingOptions */
...
IF EXISTS(SELECT * FROM dbo.ProposalPricingOptions)
	 EXEC('INSERT INTO dbo.Tmp_ProposalPricingOptions (PropPricingRno, PricingCode, Seq, OptionCheckboxDesc, OptionPropDesc, CreatedDtTm, CreatedUser, UpdatedDtTm, UpdatedUser, DeletedDtTm, DeletedUser)
		SELECT PropPricingRno, PricingCode, Seq, OptionCheckboxDesc, OptionPropDesc, CreatedDtTm, CreatedUser, UpdatedDtTm, UpdatedUser, DeletedDtTm, DeletedUser FROM dbo.ProposalPricingOptions WITH (HOLDLOCK TABLOCKX)')
GO
