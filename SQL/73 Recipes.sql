-- add 	VeganFlg, VegetarianFlg, DairyFreeFlg and NutsFlg
...
IF EXISTS(SELECT * FROM dbo.Recipes)
	 EXEC('INSERT INTO dbo.Tmp_Recipes (RecipeRno, Name, Category, SubrecipeFlg, NumServings, MenServingRatio, WomenServingRatio, ChildServingRatio, YieldQty, YieldUnitRno, PortionQty, PortionUnitRno, PortionPrice, BaseCostPrice, BaseCostPct, InaccuratePriceFlg, Instructions, Source, Images, IntNote, CT_RecipeID, MenuItemAsIsFlg, GlutenFreeFlg, HideFlg, IncludeInBookFlg, CreatedDtTm, CreatedUser, UpdatedDtTm, UpdatedUser)
		SELECT RecipeRno, Name, Category, SubrecipeFlg, NumServings, MenServingRatio, WomenServingRatio, ChildServingRatio, YieldQty, YieldUnitRno, PortionQty, PortionUnitRno, PortionPrice, BaseCostPrice, BaseCostPct, InaccuratePriceFlg, Instructions, Source, Images, IntNote, CT_RecipeID, MenuItemAsIsFlg, GlutenFreeFlg, HideFlg, IncludeInBookFlg, CreatedDtTm, CreatedUser, UpdatedDtTm, UpdatedUser FROM dbo.Recipes WITH (HOLDLOCK TABLOCKX)')
GO
