/* add CategorySortOrder to mcJobMenuItems */
...
IF EXISTS(SELECT * FROM dbo.mcJobMenuItems)
	 EXEC('INSERT INTO dbo.Tmp_mcJobMenuItems (MenuItemRno, Category, MenuItem, ProposalMenuItem, KitchenLocRno, HotFlg, ColdFlg, HideFlg, MultSelFlg, MultItems, CreatedDtTm, CreatedUser, UpdatedDtTm, UpdatedUser)
		SELECT MenuItemRno, Category, MenuItem, ProposalMenuItem, KitchenLocRno, HotFlg, ColdFlg, HideFlg, MultSelFlg, MultItems, CreatedDtTm, CreatedUser, UpdatedDtTm, UpdatedUser FROM dbo.mcJobMenuItems WITH (HOLDLOCK TABLOCKX)')
GO
