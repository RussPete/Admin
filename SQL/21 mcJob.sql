/* Add JobType & ProposalFlg & ConfirmEmailed fields*/
...
Select * from mcJobs where status = 'Proposal'
Select * from mcJobs where ProposalFlg = 1

Update mcJobs set ProposalFlg = 1 where Status = 'Proposal'
Update mcJobs set JobType = 'Private'
