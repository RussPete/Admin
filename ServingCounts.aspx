<%@ Page AutoEventWireup="true" CodeFile="ServingCounts.aspx.cs" Inherits="ServingCounts"
	Language="C#" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
	<head>
		<title><%= Globals.g.Company.Name %> - Menu Servings</title> 
		<!-- ServingCounts.aspx -->
...
%>
	...
	<body>
		<form id="form" method="post" target="_blank" runat="server" autocomplete="off">
			<% Pg.Top(); %>
			<div class="FeatureMain">Menu Item Servings</div>
