...
public class Misc
{
    ...
    private static string SignTOS =
        "Please sign the attached Terms of Service agreement and email it back to us at info@marvellouscatering.com.\n" +
	...
	TryAgain:
		...
		try
		{
            ...
            if (fProposal || dtConfirmEmailed != DateTime.MinValue || fCustomerConfirmation)
			{
                ...
                Body = string.Format(
                    "<p style='text-align: center;'><img src='http://{0}{1}' alt='Marvellous Catering Logo' width='160' /></p>",
	...
	private static string ConfirmEmail(string SignTOS, string Msg)
	{
		string s = string.Format(
			"<p style='text-align: center;'><img src='http://{0}{1}' alt='Marvellous Catering Logo' width='160' /></p>" +
			"<Custom Message>" +
			"<p>Thank you for booking your event with Marvellous Catering! For your convenience, we have attached your customized menu along with the pricing. We will call you 7-10 business days prior to the date of your event to confirm details.</p>" +
			"{2}{3}" +
