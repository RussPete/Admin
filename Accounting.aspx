<%@ Page AutoEventWireup="true" CodeFile="Accounting.aspx.cs" Inherits="Accounting"
	Language="C#" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
	...
	<body>
		<form id="form" method="post" autocomplete="off" runat="server">
			<%//= Misc.Parms(this) %>
			<% Pg.Top(); %>
			<div class="FeatureMain">Accounting</div>
			<div class="FeatureSub">Recently Edited Finalized Jobs</div>
			<table class="Acct">
				<thead>
					<tr>
						<th>Processed</th>
			...
			<div class="FeatureSub">Finalized Jobs</div>
			<table class="Acct">
				<thead>
					<tr>
						<th>Processed</th>
			...
			<div class="FeatureSub">Invoiced But Not Finalized Jobs</div>
			<table class="Acct">
				<thead>
					<tr>
						<th>Processed</th>
				...
				<tbody>
					...
					<tr class="NoPrint">
						<td colspan="3">
							<div class="CheckAll">Check All</div>
							<div class="ClearAll">Clear All</div>
							<asp:Button ID="Button2" Text="Save" runat="server" />
						</td>
                        <td colspan="8"></td>
					</tr>
				</tbody>
