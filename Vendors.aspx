<%@ Page AutoEventWireup="true" CodeFile="Vendors.aspx.cs" Inherits="Vendors" Language="C#" %>
...
/*
	        ...
	        $("#pnlNewIngred .OrderUnits").autocomplete(
            {
                //source: Ingredients,
                source: function(req, response) { 
                    var re = $.ui.autocomplete.escapeRegex(req.term); 
	...
	<table cellspacing="0" cellpadding="0" align="center" border="0">
		<tr>
            ...
            <td style="vertical-align: top;">
                <div id="content">
                    <div class="FeatureMain">Vendors</div>
                    <ul class="Fields">
                        <li>
                        ...
                        <li><label class="Prompt">Phone</label><asp:TextBox ID="txtPhone" CssClass="Name" MaxLength="50" runat="server" /></li>
                        <li><label class="Prompt">Contact Name</label><asp:TextBox ID="txtContact" CssClass="Name" MaxLength="50" runat="server" /></li>
                        <li><label class="Prompt">Email</label><asp:TextBox ID="txtEmail" CssClass="Name" MaxLength="100" runat="server" /></li>
                        <li><label class="Prompt">Website</label><asp:TextBox ID="txtWebsite" CssClass="Name" MaxLength="100" runat="server" /></li>
                    </ul>

                    <div>Note</div>
                    <asp:TextBox ID="txtNote" TextMode="MultiLine" CssClass="Note" MaxLength="2000" runat="server" />
