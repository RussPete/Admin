<%@ Page AutoEventWireup="true" CodeFile="PaymentSearch.aspx.cs" Inherits="PaymentSearch"
	Language="C#" %>
	...
	<body>
		<form id="form" method="post" autocomplete="off" runat="server">
            ...
            <div style="text-align: center; margin-bottom: 20px;">
                Payment Amount <asp:TextBox ID="txtPaymentAmt" CssClass="Amt" runat="server" /> <asp:Button ID="btnGo" Text="Go" runat="server" /> (see matches below)
            </div>
